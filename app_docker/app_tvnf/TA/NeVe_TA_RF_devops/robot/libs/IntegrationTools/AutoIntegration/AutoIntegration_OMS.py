...
class AutoIntegration_OMS(AutoIntegration):
...
if __name__ == '__main__':
    auto_integration = AutoIntegration_OMS()
    ...
    #          "NWI3 Access": {"username": "Nemuadmin", "password": "nemuuser", "group": "sysop"}})
    auto_integration.integrate_OMS(NETACT_HOST="10.91.48.122",NETACT_LBWAS="clab3187lbwas.netact.nsn-rdnet.net",OMC_USERNAME= "omc", OMC_PASSWORD="omc", OMS_DN="PLMN-PLMN/OMS-2059",NE_HOST_NAME= "10.9.221.192",
